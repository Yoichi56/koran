    ...
    <tbody>
      <?php
        foreach ($hasil as $data) {
          echo "<tr>
                  <td>".$data['kode']."-".jumlahAngka($data['kode_beban'])."</td>
                  <td>".$data['nama']."</td> ";
      ?>
                  <td align="center"> <a href="<?= site_url('beban/formUbahbeban/'.$data['kode_beban']); ?>" class="btn btn-sm btn-outline-secondary" >&nbsp;&nbsp;<i class="icon fa fa-fw fa-edit"></i></a> </td>
      <?php } ?>
    </tbody>
  </table>
</div>
